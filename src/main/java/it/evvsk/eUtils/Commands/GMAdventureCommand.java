        ...
        if (!p.hasPermission("eutils.command.gamemode.adventure")) {
            ...
            if (args.length == 1) {
                ...
                if (subjectPlayer.getName().endsWith("s")) {
                    ...
                    p.sendMessage(SC.CC("&e&lE&f&lUtils &8» &a" + subjectPlayer.getName() + "' gamemode has been changed successfully to adventure."));

                } else {

                    p.sendMessage(SC.CC("&e&lE&f&lUtils &8» &a" + subjectPlayer.getName() + "'s gamemode has been changed successfully to adventure."));

                }

                subjectPlayer.sendMessage(SC.CC("&e&lE&f&lUtils &8» &aYour gamemode has been changed successfully to adventure."));
